...
export const HelperCard = styled.div<{ $success?: boolean }>`
  padding: 16px 18px;
  border-radius: 18px;
  background: ${(props) => (props.$success ? 'rgba(57, 156, 94, 0.14)' : 'rgba(255, 255, 255, 0.05)')};
  border: 1px solid ${(props) => (props.$success ? 'rgba(57, 156, 94, 0.2)' : 'rgba(255, 255, 255, 0.08)')};
  ...
  p {
    margin-top: 8px;
    color: ${(props) => (props.$success ? '#caefcf' : '#b9b3c2')};
    line-height: 1.6;
  }
`;
...
export const Background = styled.div`
  ...
  &::before {
    ...
    height: 180px;
    border-radius: 50%;
    background: radial-gradient(circle, rgba(255, 144, 0, 0.28), transparent 70%);
    filter: blur(8px);
  }
